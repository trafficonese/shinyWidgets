                                                    ...
                                                    this.$element.on("change" + j, function () {
                                                      if (C.clickinfo && C.multiple && C.clickinfo.shiftKey) {
                                                        if (T && T[1] && T[2].length != 0) {
                                                          ...
                                                          var selprevshift = ""
                                                          if (C.selectpicker.isSearching) {
                                                            // Search is active
                                                            selprevshift = k.filter(function(ki) {return ki.text === T[2][T[2].length-1]})[0].posinset;
                                                            selnextshift = k.filter(function(ki) {return ki.index === selnextshift})[0].posinset;
                                                          } else {
                                                            selprevshift = k.filter(function(ki) {return ki.text === T[2][T[2].length-1];})[0].index;
                                                          }
                                                          //console.log("Next Index:");console.log(selnextshift);
                                                          //console.log("Previous Index:"); console.log(selprevshift);
                                                          ...
                                                          //console.log("Selection Indices:"); console.log(indexarr);
                                                          ...
                                                          //console.log("Selection Texts:"); console.log(selectext);
