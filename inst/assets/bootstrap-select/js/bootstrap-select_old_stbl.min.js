                                                ...
                                                J.VERSION = "1.13.10", J.DEFAULTS = {
                                                    ...
                                                    t.data("spaceSelect", !1), this.$button.on("keyup", function(e) {
                                                      ...
                                                      if (C.multiple && 1 !== C.options.maxOptions && e.stopPropagation(), e.preventDefault(), !C.isDisabled() && !i.parent().hasClass(j.DISABLED)) {
                                                        ...
                                                        if (r === C.activeIndex && (t = !0), t || (C.prevActiveIndex = C.activeIndex, C.activeIndex = void 0), C.multiple) {
                                                          ...
                                                          // TODO - another Shift-Click attempt
                                                          /*
                                                            if (e.shiftKey) {
                                                              console.log("Current Selection Index (r): " + r)
                                                              console.log("Previous Selection Index(a): " + a)
                                                              debugger;
                                                              const fillRange = (array) => {
                                                                var start = Math.min(...array);
                                                                var end = Math.max(...array);
                                                                return Array(end - start + 1).fill().map((item, index) => start + index);
                                                              };
                                                              var indexarr = fillRange([a, r])
                                                              indexarr.forEach(e => C.setSelected(e, 1));
                                                            }
                                                          */
                                                      ...
                                                      if (C.clickinfo && C.multiple && C.clickinfo.shiftKey) {
                                                        if (T && T[1] && T[2].length != 0) {
                                                          let k = C.selectpicker.current.data;
                                                          // Current Selection Index
                                                          let selnextshift = C.selectedIndex;
                                                          const fillRange = (array) => {
                                                          ...
                                                          // If search is active, list and indices changes
                                                          var selprevshift = ""
                                                          if (C.$searchbox.val() && C.$searchbox.val().length > 0 ) {
                                                            // Previous Selection Index
                                                            selprevshift = k.filter(function(ki) {return ki.text === T[2][T[2].length-1]})[0].posinset;
                                                          } else {
                                                            // Previous Selection Index
                                                            selprevshift = k.filter(function(ki) {return ki.text === T[2][T[2].length-1];})[0].index;
                                                          }
                                                          //selprevshift = PREVINX;
                                                          //console.log("selprevshift"); console.log(selprevshift);
                                                          //console.log("PREVINX"); console.log(PREVINX);
                                                          //debugger;

                                                          // get Indices of selections
                                                          let indexarr = fillRange([selprevshift, selnextshift]);
                                                  ...
                                                  liveSearchListener: function() {
                                                    ...
                                                    this.$button.on("click.bs.dropdown.data-api", function() {
                                                      ...
                                                      // console.log("Search property changed");
